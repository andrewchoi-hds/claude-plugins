...
claude-plugins의 주요 변경사항을 기록합니다.
...
AI의 뻔한 디자인을 탈피하고 개성있는 UI를 생성하는 새로운 스킬입니다.
...
- 레이아웃: 중앙 정렬 → 비대칭
- 타이포: Inter → 세리프 혼합
- 효과: shadow-lg → 노 섀도우 or 극단적

### 프로젝트 확장

- 프로젝트명 변경: `session-wrap` → `claude-plugins`
- 멀티 스킬 구조: `/wrap` + `/ui`

### 추가된 파일

- `.claude/commands/ui.md` - Fresh UI 스킬 정의
- `.claude/settings.json` - v1.2.0 업데이트
